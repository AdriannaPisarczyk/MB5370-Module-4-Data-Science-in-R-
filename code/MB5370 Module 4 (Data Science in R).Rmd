---
title: "MB5370 Module 4 (Data Science in R)"
...
Basing my data analysis off Figure 1 from the paper:

![](images/clipboard-2577092648.png)

Figure 1 - The global percentage of decline was calculated from the posteriors of the LPI around the final assessment year relative to the posteriors for 1970. The black line denotes the mean, the white lines the 95% credible intervals and the grey lines each iteration.
...
# Set file path (update this to your local path)
file_path <- "C:/Users/Adrianna/Documents/AUSTRALIA/JCU/MY CLASSES/Year 2 SEM 1/MB5370 - Marine Techniques 1/Pacoureaudata.csv"
...
Develop a full end-to-end analysis of a dataset in R. Show you how to take any dataset and use your skills as a marine data scientist to build impressive analyses and data visualisations that you can share with end-users. 

```{r echo=T, message=FALSE, warning=FALSE, results="hide"}

"C:/Users/Adrianna/Documents/AUSTRALIA/JCU/MY CLASSES/Year 2 SEM 1/MB5370 - Marine Techniques 1/MB5370 Module 4 (Data Science in R)/data/SharkControl.csv"

library(tidyverse)

# Assuming your working directory is the project folder.
SharkControl <- read_csv("SharkControl.csv")

# View a few rows to confirm it loaded
head(SharkControl)
