...
Using Queensland Shark Control Program data, created a bar chart depicting the total number of sharks killed by the Queensland Shark Control Program from 2001 to 2025.

```{r echo=T, message=FALSE, warning=FALSE}

library(tidyverse)

# Import the SharkControl dataset from the 'data' folder within your project
...
# Part 5: **How to use R for spatial analyses**
